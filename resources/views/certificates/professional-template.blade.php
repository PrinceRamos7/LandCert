    ...
    <div class="certificate">
        ...
        <div class="header">
            <div class="logos-section">
                <div class="logo">
                    <img src="{{ asset('images/cdrrmo.png') }}" alt="CDRRMO Logo">
                </div>
                <div class="header-text">
                    <div class="republic">Republic of the Philippines</div>
                    <div class="office-name">CITY OF ILAGAN</div>
                    <div class="office-main">CITY DISASTER RISK REDUCTION</div>
                    <div class="office-main">AND MANAGEMENT OFFICE</div>
                    <div class="address">CDRRMO Building, City of Ilagan, Isabela</div>
                </div>
                <div class="logo">
        ...
        <div class="content">
            ...
            <p>The proposed <span class="project-details">{{ $projectType }}</span> project has been evaluated and found to be in accordance with the existing land use plan, zoning ordinances, and disaster risk management guidelines of the City of Ilagan.</p>
        </div>
        ...
        <div class="signature-section">
            ...
            <div class="signature-right">
                ...
                <div class="signature-name">GERALYN G. GAÑGAN, RN, EMT-B</div>
                <div class="signature-title">City DRRM Officer</div>
                <div class="signature-credentials">Registered Nurse, Emergency Medical Technician-Basic</div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="footer-contact">
                This certificate is valid and verifiable. For verification, contact CDRRMO Ilagan.
            </div>
        </div>
    </div>
</body>
